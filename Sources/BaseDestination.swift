...
open class BaseDestination: Hashable, Equatable {
    ...
    open var minLevel = SwiftyBeaverLogger.Level.verbose
    ...
    open func send(_ level: SwiftyBeaverLogger.Level, msg: String, thread: String, file: String,
    ...
    func formatMessage(_ format: String, level: SwiftyBeaverLogger.Level, msg: String, thread: String,
    ...
    func messageToJSON(_ level: SwiftyBeaverLogger.Level, msg: String,
    ...
    func levelWord(_ level: SwiftyBeaverLogger.Level) -> String {
    ...
    func colorForLevel(_ level: SwiftyBeaverLogger.Level) -> String {
        var color = ""
    ...
    func shouldLevelBeLogged(_ level: SwiftyBeaverLogger.Level, path: String,
