...
struct FilterValidator {
    ...
    struct Input {
        ...
        let level: SwiftyBeaverLogger.Level
        let path: String
        let function: String
        let message: String?
    }
    ...
    private static func filterMatchesCondition(_ filter: FilterType, level: SwiftyBeaverLogger.Level,
    ...
    private static func filterMatchesMinLogLevel(_ filter: FilterType, level: SwiftyBeaverLogger.Level) -> Bool {
