...
public protocol FilterType : AnyObject {
    ...
    func reachedMinLevel(_ level: SwiftyBeaverLogger.Level) -> Bool
}
...
public class Filter {
    ...
    let required: Bool
    let minLevel: SwiftyBeaverLogger.Level

    public init(_ target: Filter.TargetType, required: Bool, minLevel: SwiftyBeaverLogger.Level) {
    ...
    public func reachedMinLevel(_ level: SwiftyBeaverLogger.Level) -> Bool {
...
public class CompareFilter: Filter, FilterType {
    ...
    override public init(_ target: Filter.TargetType, required: Bool, minLevel: SwiftyBeaverLogger.Level) {
...
public class FunctionFilterFactory {
    public static func startsWith(_ prefixes: String..., caseSensitive: Bool = false,
                                  required: Bool = false, minLevel: SwiftyBeaverLogger.Level = .verbose) -> FilterType {
    ...
    public static func custom(required: Bool = false, minLevel: SwiftyBeaverLogger.Level = .verbose, filterPredicate: @escaping (String) -> Bool) -> FilterType {
