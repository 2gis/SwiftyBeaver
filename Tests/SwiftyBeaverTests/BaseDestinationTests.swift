...
class BaseDestinationTests: XCTestCase {
    ...
    func testMessageToJSON() {
        ...
        XCTAssertEqual(level, SwiftyBeaverLogger.Level.info.rawValue)
    ...
    func testLevelWord() {
        ...
        str = obj.levelWord(SwiftyBeaverLogger.Level.verbose)
        XCTAssertNotNil(str, "VERBOSE")
        str = obj.levelWord(SwiftyBeaverLogger.Level.debug)
        XCTAssertNotNil(str, "DEBUG")
        str = obj.levelWord(SwiftyBeaverLogger.Level.info)
        XCTAssertNotNil(str, "INFO")
        str = obj.levelWord(SwiftyBeaverLogger.Level.warning)
        XCTAssertNotNil(str, "WARNING")
        str = obj.levelWord(SwiftyBeaverLogger.Level.error)
    ...
    func testColorForLevel() {
        ...
        // empty on default
        str = obj.colorForLevel(SwiftyBeaverLogger.Level.verbose)
        XCTAssertNotNil(str, "")
        str = obj.colorForLevel(SwiftyBeaverLogger.Level.debug)
        XCTAssertNotNil(str, "")
        str = obj.colorForLevel(SwiftyBeaverLogger.Level.info)
        XCTAssertNotNil(str, "")
        str = obj.colorForLevel(SwiftyBeaverLogger.Level.warning)
        XCTAssertNotNil(str, "")
        str = obj.colorForLevel(SwiftyBeaverLogger.Level.error)
        XCTAssertNotNil(str, "")
    ...
    func test_init_noMinLevelSet() {
        ...
        XCTAssertTrue(destination.shouldLevelBeLogged(SwiftyBeaverLogger.Level.verbose, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(SwiftyBeaverLogger.Level.debug, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(SwiftyBeaverLogger.Level.info, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(SwiftyBeaverLogger.Level.warning, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(SwiftyBeaverLogger.Level.error, path: "", function: ""))
    }

    func test_init_minLevelSet() {
        let destination = BaseDestination()
        destination.minLevel = SwiftyBeaverLogger.Level.info
        XCTAssertFalse(destination.shouldLevelBeLogged(SwiftyBeaverLogger.Level.verbose, path: "", function: ""))
        XCTAssertFalse(destination.shouldLevelBeLogged(SwiftyBeaverLogger.Level.debug, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(SwiftyBeaverLogger.Level.info, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(SwiftyBeaverLogger.Level.warning, path: "", function: ""))
        XCTAssertTrue(destination.shouldLevelBeLogged(SwiftyBeaverLogger.Level.error, path: "", function: ""))
    }
    ...
    func test_shouldLevelBeLogged_hasMinLevel_True() {
        let destination = BaseDestination()
        destination.minLevel = SwiftyBeaverLogger.Level.verbose
        destination.addFilter(Filters.Path.equals("/world/beaver.swift", caseSensitive: true, required: true))
        XCTAssertTrue(destination.shouldLevelBeLogged(SwiftyBeaverLogger.Level.warning,
    ...
    func test_shouldLevelBeLogged_hasMinLevelAndOneRequiredMessageFilterAndDoesPass_True() {
        let destination = BaseDestination()
        destination.minLevel = SwiftyBeaverLogger.Level.error
        destination.addFilter(Filters.Message.contains("Required", caseSensitive: false, required: true, minLevel: .info))
